...
import { blogPosts, site, sourcePlaceholders } from '../../data';
...
export default async function Post({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const articleSchema = {
    ...
    citation: sourcePlaceholders.map((source) => source.url),
  };
  const faqSchema = {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
