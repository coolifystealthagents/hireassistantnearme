import { sep24Hira96ResearchPosts as posts } from '../app/research-sep24-hira96.ts';

const base = process.env.VALIDATION_BASE_URL || 'http://127.0.0.1:3222';
const expectedDate = process.env.EXPECTED_PUBLICATION_DATE || '2026-09-24';
const failures = [];
...
for (const post of posts) {
  ...
  const checks = [
    ...
    [html.includes(`dateTime="${expectedDate}"`) && html.includes('September 24, 2026'), 'visible date mismatch'],
...
console.log('Validated 5/5 September 24 Research articles.');
